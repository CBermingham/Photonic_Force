...
plt.scatter(z1, sum1, color = 'darkorange', s = 3, label = "%.1f$\degree$" % angle1)
# plt.plot(z1, fit1, color = 'r')
plt.scatter(z2, sum2, color = 'g', s = 3, label = "%.1f$\degree$" % angle2)
# plt.plot(z2, fit2, color = 'r')
# plt.scatter(z7, sum7, color = 'darkorange', s = 3, label = "%.1f$\degree$" % angle7)
# plt.plot(z7, fit7, color = 'darkorange')
plt.scatter(z3, sum3, color = 'purple', s = 3, label = "%.1f$\degree$" % angle3)
...
plt.plot(z1, sum1, color = 'darkorange')
plt.plot(z1, fit1, color = 'darkorange', linestyle = '--')
plt.plot(z2, sum2, color = 'g')
plt.plot(z2, fit2, color = 'g', linestyle = '--')
# plt.plot(z7, sum7, color = 'darkorange', label = "%.1f$\degree$" % angle7)
# plt.plot(z7, fit7, color = 'darkorange', linestyle = '--')
plt.plot(z3, sum3, color = 'purple')
plt.plot(z3, fit3, color = 'purple', linestyle = '--')
...
plt.yticks(size = 14)
#plt.savefig('multiple_scattering_with_fit_to_all.pdf')
plt.savefig("Tip_shape_exp_field_ITO.pdf")
plt.show()
